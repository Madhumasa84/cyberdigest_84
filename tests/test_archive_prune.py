...
def test_global_archive_prune_unlink_error(isolated_app, monkeypatch):
    import cyberdigest.config as config_mod
    import cyberdigest.reports as reports
...
def test_category_archive_prune_unlink_error(isolated_app, monkeypatch):
    import cyberdigest.config as config_mod
    import cyberdigest.reports as reports
